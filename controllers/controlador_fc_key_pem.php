...
use gamboamartin\facturacion\html\fc_key_pem_html;
...
class controlador_fc_key_pem extends system{

    public array|stdClass $keys_selects = array();

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new fc_key_pem(link: $link);
        $html_ = new fc_key_pem_html(html: $html);
    ...
    {
        $columns["fc_key_pem_id"]["titulo"] = "Id";
        $columns["fc_key_pem_codigo"]["titulo"] = "Código";
        $columns["doc_documento_descripcion"]["titulo"] = "Documento";

        $filtro = array("fc_key_pem.id","fc_key_pem.codigo","doc_documento.descripcion");
    ...
    private function init_modifica(): array|stdClass
    {
        ...
        $identificador = "fc_key_csd_id";
        $propiedades = array("id_selected" => $this->row_upd->fc_key_csd_id);
        $this->asignar_propiedad(identificador:$identificador, propiedades: $propiedades);
