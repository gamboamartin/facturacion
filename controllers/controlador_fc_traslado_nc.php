...
use gamboamartin\facturacion\html\fc_traslado_nc_html;
...
class controlador_fc_traslado_nc extends _base_system_conf {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $html_ = new fc_traslado_nc_html(html: $html);
    ...
    {
        $columns["fc_traslado_nc_id"]["titulo"] = "Id";
        $columns["fc_traslado_nc_codigo"]["titulo"] = "Código";
        $columns["fc_partida_descripcion"]["titulo"] = "Partida";
        $columns["fc_traslado_nc_descripcion"]["titulo"] = "Descripción";
        ...
        $filtro = array("fc_traslado_nc.id","fc_traslado_nc.codigo","fc_traslado_nc.descripcion","fc_partida.descripcion",
