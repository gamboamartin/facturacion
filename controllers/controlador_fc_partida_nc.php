...
class controlador_fc_partida_nc extends _base {
    ...
    private function init_datatable(): stdClass
    {
        ...
        $columns["fc_nota_credito_descripcion"]["titulo"] = "Nota Credito";
        $columns["fc_partida_nc_cantidad"]["titulo"] = "Cantidad";
        $columns["fc_partida_nc_valor_unitario"]["titulo"] = "Valor Unitario";
        $columns["fc_partida_nc_descuento"]["titulo"] = "Descuento";
        $columns["fc_partida_nc_traslados"]["titulo"] = "# Traslados";
        $columns["fc_partida_nc_retenidos"]["titulo"] = "# Retenidos";

        $filtro = array("fc_partida_nc.id","fc_partida_nc.codigo","fc_nota_credito.descripcion","com_producto.descripcion",
            "fc_partida_nc.cantidad","fc_partida_nc.valor_unitario","fc_partida_nc.descuento");
    ...
    public function init_links(): array|string
    {
        $this->link_fc_traslado_alta_bd = $this->obj_link->link_con_id(accion: 'nuevo_traslado_bd', link: $this->link,
            registro_id: $this->registro_id, seccion: "fc_partida_nc");
        if (errores::$error) {
    ...
    public function nuevo_traslado(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $table = $this->datatable_init(columns: $datatables->columns, filtro: $datatables->filtro,
            identificador: "#fc_traslado", data: array("fc_partida_nc.id" => $this->registro_id));
        if (errores::$error) {
        ...
        $this->controlador_fc_traslado->row_upd->codigo = $partida["fc_partida_nc_codigo"];
        $this->controlador_fc_traslado->row_upd->descripcion = $partida["fc_partida_nc_descripcion"];

        $identificador = "fc_partida_nc_id";
        $propiedades = array("id_selected" => $this->registro_id, "disabled" => true,
            "filtro" => array('fc_partida_nc.id' => $this->registro_id));
    ...
    public function nuevo_traslado_bd(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $registro = $_POST;
        $registro['fc_partida_nc_id'] = $this->registro_id;
        $registro['codigo'] = $partida['fc_partida_nc_id'].$registro['descripcion'];
