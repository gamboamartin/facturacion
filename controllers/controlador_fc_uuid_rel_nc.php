...
class controlador_fc_uuid_rel_nc extends _ctl_base {
    ...
    protected function campos_view(): array
    {
        ...
        $init_data['fc_relacion_nc'] = "gamboamartin\\facturacion";
    ...
    public function init_datatable(): stdClass
    {
        ...
        $filtro = array("fc_uuid_rel_nc.id", "fc_uuid_rel_nc.codigo", "fc_uuid_rel_nc.descripcion",
            "fc_relacion_nc.descripcion", "fc_cfdi.descripcion"
        );
    ...
    public function init_selects_inputs(): array
    {
        ...
        $keys_selects = $this->init_selects(keys_selects: $keys_selects, key: "fc_relacion_nc_id", label: "Relacion nc");
        if(errores::$error){
            return $this->errores->error(mensaje: 'Error al maquetar key_selects', data: $keys_selects);
        }
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects['fc_relacion_nc_id']->id_selected = $this->registro['fc_relacion_nc_id'];
