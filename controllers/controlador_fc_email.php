...
use gamboamartin\facturacion\html\fc_email_html;
...
class controlador_fc_email extends system{
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $modelo = new fc_email(link: $link);
        $html_ = new fc_email_html(html: $html);
