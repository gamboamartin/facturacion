...
class fc_partida_nc extends _partida
{
    public function __construct(PDO $link)
    {
        ...
        $columnas_extra['fc_partida_nc_importe_total_traslado'] = "$tabla.total_traslados";
        $columnas_extra['fc_partida_nc_importe_total_retenido'] = "$tabla.total_retenciones";
        $columnas_extra['fc_partida_nc_importe_total'] = "$tabla.sub_total 
        + $tabla.total_traslados - $tabla.sub_total";
