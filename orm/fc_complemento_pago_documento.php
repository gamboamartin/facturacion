...
class fc_complemento_pago_documento extends _modelo_parent {
    ...
    public function get_factura_documento(int $fc_complemento_pago_id, string $tipo_documento): array|string{


        $documento = $this->get_factura_documentos(fc_complemento_pago_id: $fc_complemento_pago_id,tipo_documento: $tipo_documento);
        if (errores::$error) {
    ...
    public function get_factura_documentos(int $fc_complemento_pago_id, string $tipo_documento): array|stdClass{
