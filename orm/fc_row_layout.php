...
class fc_row_layout extends modelo{
    ...
    {
        $rs_alta_bd = parent::alta_bd(); // TODO: Change the autogenerated stub
        if(errores::$error){
            return (new errores())->error('Error al modificar row', $rs_alta_bd);
        }

        $rs = $this->recalcula_cliente_comision(fc_row_layout_id: $rs_alta_bd->registro_id);
        if(errores::$error){
            return (new errores())->error('Error al recalcula_cliente_comision', $rs);
        }
    ...
    public function modifica_bd(array $registro, int $id, bool $reactiva = false): array|\stdClass
    {
        ...
        $rs = $this->recalcula_cliente_comision(fc_row_layout_id: $id);
        if(errores::$error){
            return (new errores())->error('Error al recalcula_cliente_comision', $rs);
        }
    ...
    public function recalcula_cliente_comision(int $fc_row_layout_id): array
    {
        ...
        $consulta = "UPDATE fc_row_layout SET fc_row_layout.comision_cliente = $comision WHERE fc_row_layout.id = $fc_row_layout_id";
