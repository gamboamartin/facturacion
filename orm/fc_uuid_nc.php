...
class fc_uuid_nc extends _uuid_ext {
    public function __construct(PDO $link){
        $tabla = 'fc_uuid_nc';
        $columnas = array($tabla=>false,'fc_uuid'=>$tabla,'fc_relacion_nc'=>$tabla,
            'cat_sat_tipo_relacion'=>'fc_relacion_nc','cat_sat_tipo_de_comprobante'=>'fc_uuid',
            'com_sucursal'=>'fc_uuid','com_cliente'=>'com_sucursal','fc_csd'=>'fc_uuid','org_sucursal'=>'fc_csd',
            'org_empresa'=>'org_sucursal');

        $no_duplicados = array();

        $campos_obligatorios = array('fc_uuid_id','fc_relacion_nc_id');
