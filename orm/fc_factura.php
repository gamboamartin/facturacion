...
class fc_factura extends modelo{
    ...
    private function defaults_alta_bd(array $registro, stdClass $registro_cfd): array
    {
        ...
        if(!isset($registro['descripcion_select'])) {
            $descripcion_select = $this->descripcion_select_default(registro_cfd: $registro_cfd,
    ...
    private function descripcion_select_default(stdClass $registro_cfd, stdClass $registro_com_sucursal): string
    {
