...
class fc_factura extends modelo{
    ...
    public function alta_bd(): array|stdClass
    {
        ...
        if(isset($this->registro['subtotal'])){
            unset($this->registro['subtotal']);
        }
        if(isset($this->registro['total'])){
            unset($this->registro['total']);
        }
        if(isset($this->registro['descuento'])){
            unset($this->registro['descuento']);
        }
        ...
        $this->registro['descripcion_select'] = $registro_cfd->org_empresa_razon_social.' '.
