...
class fc_factura extends modelo
{
    ...
    public function elimina_bd(int $id): array|stdClass
    {
        ...
        $fc_factura_etapas = $r_fc_factura_etapa->registros;
        ...
        if(!$permite_eliminacion){
            return $this->error->error(mensaje: 'Error no se permite la eliminacion', data: $fc_factura_etapas);
        }
