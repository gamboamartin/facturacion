...
class _transacciones_fc extends modelo
{
                                      ...
                                      _uuid_ext $modelo_uuid_ext, int $registro_id): array|stdClass|int
    {
        ...
        foreach ($registro['partidas'] as $key => $partida) {
            ...
            $datos = (new _conceptos())->integra_partidas(conceptos: $conceptos, key: $key,
                key_filtro_id: $this->key_filtro_id, modelo_partida: $modelo_partida, modelo_predial: $modelo_predial,
                modelo_retencion: $modelo_retencion, modelo_traslado: $modelo_traslado, partida: $partida,
                registro: $registro, registro_id: $registro_id, ret_global: $ret_global,
            ...
            $ret_global = $datos->ret_global;
            $trs_global = $datos->trs_global;
            $total_impuestos_trasladados = $datos->total_impuestos_trasladados;
            $total_impuestos_retenidos = $datos->total_impuestos_retenidos;
