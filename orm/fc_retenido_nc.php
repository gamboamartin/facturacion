...
class fc_retenido_nc extends _data_impuestos {
    public function __construct(PDO $link, _partida|stdClass $modelo_partida = new stdClass()){
        ...
        $campos_view['fc_partida_nc_id'] = array('type' => 'selects', 'model' =>$modelo_partida);
        ...
        $columnas_extra['fc_retenido_nc_importe'] = $fc_impuesto_importe;
