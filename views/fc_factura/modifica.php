...
<div class="partidas" style="margin-top: 20px;">
    <div class="col-lg-12">
        <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
            ...
            <?php foreach ($controlador->partidas->registros as $partida) { ?>
                ...
                <table class='table table-striped data-partida' style='border: 2px solid'>
                    ...
                    <tr class="tr_fc_partida_descripcion">
                        <td colspan='5' class="td_fc_partida_descripcion"
                            data-fc_partida_factura_id="<?php echo $partida['fc_partida_id']; ?>">
                            <input type="text" class="form-control form-control-sm fc_partida_descripcion"
                                   name="descripcion"
                                   value="<?php echo $partida['fc_partida_descripcion']; ?>"/>
                        </td>
                    </tr>
                    ...
                    <tr class="tr_data_partida">
                        <td class="td_fc_partida_cantidad">
                            <input type="text" class="form-control form-control-sm fc_partida_cantidad"
                                   name="cantidad" value="<?php echo $partida['fc_partida_cantidad']; ?>"/>
                        </td>
                        <td class="td_fc_partida_valor_unitario">
                            <input type="text" class="form-control form-control-sm fc_partida_valor_unitario"
                                   name="valor_unitario"
                                   value="<?php echo $partida['fc_partida_valor_unitario']; ?>"/>
                        </td>
                        <td class="td_fc_partida_sub_total_base">
                            <input type="text" class="form-control form-control-sm fc_partida_sub_total_base"
                                   disabled value="<?php echo $partida['fc_partida_sub_total_base']; ?>"/>
                        </td>
                        <td class="td_fc_partida_descuento">
                            <input type="text" class="form-control form-control-sm fc_partida_descuento"
                                   name="descuento" value="<?php echo $partida['fc_partida_descuento']; ?>"/>
                        </td>

                    </tr>

                    <tr class="tr_data_partida_rs">
                        <td class="td_fc_partida_sub_total"><b>Sub
                                Total: </b><?php echo $partida['fc_partida_sub_total']; ?></td>
                        <td class="td_fc_partida_traslados">
                            <b>Traslados: </b><?php echo $partida['fc_partida_total_traslados']; ?></td>
                        <td class="td_fc_partida_retenciones">
                            <b>Retenciones: </b><?php echo $partida['fc_partida_total_retenciones']; ?></td>
                        <td class="td_fc_partida_total">
                            <b>Total: </b><?php echo $partida['fc_partida_total']; ?></td>
                    </tr>
                    <tr class='tr_elimina_partida'>
                        <td colspan='5' class='td_elimina_partida'>
                            <button type='button' class='btn btn-danger col-md-12 elimina_partida'
                                    data-fc_partida_factura_id='<?php echo $partida['fc_partida_id']; ?>'
                                    value='elimina' name='btn_action_next'>Elimina
                            </button>
                        </td>
                    </tr>
                    </tbody>
