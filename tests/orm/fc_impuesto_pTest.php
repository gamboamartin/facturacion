...
class fc_impuesto_pTest extends test {
    ...
    public function test_existe_fc_impuesto_p(): void
    {
        errores::$error = false;
        ...
        $modelo = new fc_impuesto_p($this->link);
        ...
        $resultado = $modelo->existe_fc_impuesto_p($fc_complemento_pago_id);
