...
VALUES (1, 'MEX MXN 2025-09-05', 'MEX MXN 2025-09-05', 'activo', 2, 2, '2025-09-05 11:46:24', '2025-09-05 11:46:24', 
    ...
    final public function insert_fc_csd(PDO $link)
    {
        $this->link = $link;
        ...
        $x = file_put_contents('/var/www/html/facturacion/archivos/xxx.pdf', 'test');
        $sql = "INSERT INTO fc_csd (id, codigo, status, usuario_alta_id, usuario_update_id, fecha_alta, 
                    fecha_update, descripcion_select, alias, codigo_bis, serie, org_sucursal_id, 
                    descripcion, no_certificado, password, etapa) VALUES (1, '1', 'activo', 2, 2, '2025-09-04 08:47:52', 
                                                                          '2025-09-04 08:47:52', '2', '2', '2', '2', 1, 
                                                                          '1', '999999', 'SP', 'ALTA');";
    ...
    final public function insert_fc_factura(PDO $link)
    {
        $this->link = $link;
    ...
    final public function insert_fc_factura_documento(PDO $link)
    {
        $this->link = $link;
